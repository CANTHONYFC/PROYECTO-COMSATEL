...
public class GenericoBase {
	...
	public static Integer contar(String nombreQuery, List<ParametroPersistenciaGenerico> parametros, Session session,
			String nombreAlias) {
		/* DIALECTO */
	...
	public static Integer contar(List<ParametroPersistenciaGenerico> parametros, Session session,
	...
	public static Query getNamedQueryByPatametersSet(Query query, List<ParametroPersistenciaGenerico> parameters) {
		if (parameters == null)
			return query;
		...
		for (ParametroPersistenciaGenerico item : parameters) {
			...
			if (UString.existeEnLista(query.getNamedParameters(), parameter)) {
				...
				logger.error("=======> parametro no encontrado :" + parameter);
			}
		}
		return query;
	}
	...
	public static Object buscarGenerico(String nombreQuery, List<ParametroPersistenciaGenerico> parametros,
	...
	public static String getWhereClause(List<ParametroPersistenciaGenerico> parametros, StringBuilder sentenciaSQL) {
		String and = " AND ";
	...
	public static List<Class> listarConPaginacion(ParametroPaginacionGenerico parametroPaginacion,
			List<ParametroPersistenciaGenerico> parametros, String nombreQuery, Class clazz, String condicionesConsulta,
			Session session, String nombreAlias) {
		...
		if (parametroPaginacion.getPaginacionRegistrosPorPagina() == null)
			parametroPaginacion.setPaginacionRegistrosPorPagina(50);
		if (parametroPaginacion.getPaginacionRegistroInicio() == null)
