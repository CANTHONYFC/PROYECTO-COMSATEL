...
public class GenericoSecurityFilterPrivate  implements Filter{
	private static Logger logger = LogManager.getLogger(GenericoSecurityFilterPrivate.class);
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		//logger.debug("GenericoSecurityFilterPrivate.doFilter:"+uuids);
		...
		//logger.debug(usuarioSeguro+":"+uuids);
		...
		if (UString.estaVacio(springToken.getToken())) {
			...
			if ( UString.obtenerSinNulo(usuarioSeguro).equals(ConstanteMultitenancy.USUARIO_SEGURO_KEY) ) {
				logger.debug("GenericoSecurityFilterPrivate.doFilter: usuario seguro:"+uuids);
