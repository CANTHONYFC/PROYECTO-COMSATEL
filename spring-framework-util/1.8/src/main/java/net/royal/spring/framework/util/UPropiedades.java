...
public class UPropiedades {
	...
	public Properties abrir(String archivoPropiedades) throws IOException {
		Properties prop = new Properties();
		InputStream input = this.getClass().getClassLoader().getResourceAsStream(archivoPropiedades);
		prop.load(input);
		return prop;
	}
	
	public Properties abrir(String ruta,String archivoPropiedades) throws IOException {
